...
Each marker is one of the 80 highest-scoring players in the 2025-26 season. Salary runs along the x-axis, EFF along the y-axis, shape marks position (circles for guards, triangles for forwards, squares for centers), and color marks points per game on a continuous scale from purple to yellow.
